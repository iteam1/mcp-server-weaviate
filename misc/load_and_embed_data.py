...
def create_collection_with_vectorizer(client, topic_name):
    ...
    try:
        ...
        print(f"✅ Created collection: {class_name} (with OpenAI text-embedding-3-small)")
        return class_name
...
def main():
    ...
    try:
        ...
        print(f"\n✅ Embedding complete!")
        print(f"📊 Successfully embedded {total_embedded} Q&A pairs across {successful_topics} collections")
